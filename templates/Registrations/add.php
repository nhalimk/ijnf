 ...
 * @var \Cake\Collection\CollectionInterface|string[] $registrationtypes
 * @var \Cake\Collection\CollectionInterface|string[] $reasons
 * @var \Cake\Collection\CollectionInterface|string[] $parentRegistrations
 */
?>
<div class="row">
    <aside class="column">
